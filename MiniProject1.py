...
while True:
    ...
    # Take input from user to enter either Rock, Paper, Scissor    
    print("Enter choice \n 1. rock \n 2. paper \n 3. scissor \n") 
    ...
    # Random selection between Rock, Paper and Scissor by the computer
    import random
    comp_choice = random.choice(['rock','paper','scissor']) 

    # Computers choice is printed
    print("Computer choice is: " + comp_choice + "\n") 
  
    # User Choice and Computer Choice is printed
    print("\t" + user_choice + "\n V/s \n" + "\t"+ comp_choice) 
    

    # Wining conditions are decided according to the Game Instructions
    result = None
...
print("\nThanks for playing  The Rock Paper Scissor Game \n") 
